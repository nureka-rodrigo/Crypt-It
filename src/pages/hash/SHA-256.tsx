        ...
        <div className="max-w-7xl py-8 space-y-8 mx-auto">
          <div className="container mx-auto">
            ...
            <p className="mt-4 text-neutral-700 dark:text-neutral-300 text-justify">
              ...
              family of hash functions, SHA-256 provides a higher level of
              security compared to its predecessor, SHA-1. The primary purpose
              of SHA-256 is to ensure data integrity and secure information
            ...
            <p className="mt-4 text-neutral-700 dark:text-neutral-300 text-justify">
              ...
              applications, including digital signatures, certificate
              generation, and secure password storage. Due to its robustness and
            ...
            <p className="mt-4 text-neutral-700 dark:text-neutral-300 text-justify">
              ...
              SHA-256 hashes data. Explore the power of cryptographic hashing
              and see how small changes in the input data can result in
