...
export const RSAOAEP = () => {
  ...
  return (
    <CipherPageLayout
      category="Asymmetric"
      categoryHref="/asymmetric/rsa-oaep"
      title="RSA-OAEP Cipher"
      description={
        <>
          <p>
            RSA is an asymmetric cipher based on the practical difficulty of
            factoring the product of two large primes. A public key (used to
            encrypt) and a private key (used to decrypt) are derived from this
            product. Anyone can encrypt with the public key; only the holder of
            the private key can decrypt.
          </p>
          <p>
            OAEP (Optimal Asymmetric Encryption Padding) adds randomness before
            encrypting, ensuring the same plaintext produces different ciphertext
            each time and preventing structural attacks on raw RSA. This
            implementation generates 2048-bit keys and uses SHA-256 as the
