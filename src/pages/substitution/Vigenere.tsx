        ...
        <div className="max-w-7xl py-8 space-y-8 mx-auto">
          <div className="container mx-auto">
            ...
            <p className="mt-4 text-neutral-700 dark:text-neutral-300 text-justify">
              ...
              'Z'. The first letter of the plaintext is encrypted using the
              Caesar cipher row corresponding to the first letter of the
              keyword, the second letter of the plaintext is encrypted using the
              Caesar cipher row corresponding to the second letter of the
              keyword, and so on. If the keyword is shorter than the plaintext,
            ...
            <p className="mt-4 text-neutral-700 dark:text-neutral-300 text-justify">
              ...
              shifted by the position of 'E' (which is 4 positions down), and so
              forth. The resulting ciphertext would be a seemingly random string
            ...
            <p className="mt-4 text-neutral-700 dark:text-neutral-300 text-justify">
              ...
              that the German cryptanalyst Friedrich Kasiski developed a method
              for breaking it by identifying the length of the keyword and using
              frequency analysis on the individual Caesar ciphers within it.
            ...
            <p className="mt-4 text-neutral-700 dark:text-neutral-300 text-justify">
              ...
              cryptography, illustrating the principles of polyalphabetic
              substitution and the evolution of encryption techniques.
              Understanding the Vigenère cipher provides a foundation for
              grasping more advanced encryption methods that build on its
              concepts to achieve greater security in the digital age.
            </p>
          </div>
