      ...
      <section className="max-w-7xl py-8 space-y-8 mx-auto">
        <div className="container mx-auto">
          ...
          <p className="mt-4 text-neutral-700 dark:text-neutral-300 text-justify">
            The Advanced Encryption Standard in Galois/Counter Mode (AES-GCM) is
            a highly secure and efficient encryption method that combines the
            AES block cipher with Galois field multiplication for message
            authentication. AES-GCM is widely used in modern cryptographic
            applications due to its strong security guarantees and performance.
          </p>
          <p className="mt-4 text-neutral-700 dark:text-neutral-300 text-justify">
            In AES-GCM, the encryption and authentication processes are combined
            into a single operation, which ensures data confidentiality and
            integrity. The mode generates a unique authentication tag for each
            message, providing additional security against tampering.
          </p>
          <p className="mt-4 text-neutral-700 dark:text-neutral-300 text-justify">
            AES-GCM is highly efficient and can be parallelized, making it
            suitable for high-performance applications such as secure
            communications and data storage. The initialization vector (IV) used
            in AES-GCM must be unique for each encryption operation to ensure
            security.
          </p>
        </div>
